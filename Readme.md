...
* Адаптированный сайт с использованием сборщика gulp и препроцессора sass. В проекте реализован слайдер "до/после" и бургер меню с помощью нативного js. Иконки подключены с помощью svg-sprite (stack), изображения все в webP формате и минифицированы, также адаптированы под разные устройства и для ретины экрана.
  
* Студент: [Милена Аллаярова](https://up.htmlacademy.ru/adaptive-individual/1/user/2453527).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-adaptive/2453527-cat-energy-1) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии будет скопирован в ваш аккаунт.
...
[check-image]: https://github.com/htmlacademy-adaptive/2453527-cat-energy-1/workflows/Project%20check/badge.svg?branch=master
[check-url]: https://github.com/htmlacademy-adaptive/2453527-cat-energy-1/actions
